...
public class AppLogInfoForHost
{
    ...
    public static   WindowHandlerForHost handler;


    public AppLogInfoForHost()
    {
...
//            int limit = 1000000000; // 1 Gb
            ...
            int numLogFiles = 100;
            FileHandler fh = new FileHandler("MARS-Host-LogFile-%g.log", limit, numLogFiles, append);
...
*/
            ...
            handler = WindowHandlerForHost.getInstance();
...
//    public static int logFileCounterHelper;
    public static void clearAllFile()
    {
        ...
        {
    		File file = new File("MARS-Host-LogFile-"+ logFileCounter +".log");
