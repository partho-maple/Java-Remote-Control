 ...
 */
public class HostLogListViewer extends javax.swing.JFrame {

    public int counter;


    /** Creates new form AbministratorLogListViewer */
    public HostLogListViewer() {
...
//        this loop shows the log files on the list viewer
        for( counter=0; ; )
        {
    		File file = new File("MARS-Host-LogFile-"+ counter +".log");

    		if(file.exists())
                {
    			listModel.addElement("MARS-Host-LogFile-"+ counter +".log");
                        counter++;
    		}
    ...
    private void ViweLogButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViweLogButtonActionPerformed
        ...
        LogFileViewerForHost.main(null);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                HostLogListViewer ALLV = new HostLogListViewer();
