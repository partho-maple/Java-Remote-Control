 ...
 */
public class LogFileViewerForAdmin extends javax.swing.JFrame {

    /** Creates new form LogFileViewerForAdmin */
    public LogFileViewerForAdmin() {

        setIconImage(Toolkit.getDefaultToolkit().getImage("resourse/kdm-config-icon.png"));

        initComponents();
        setTitle("MARS-Administrator-LogFile-"+ AbministratorLogListViewer.index +".log");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                LogFileViewerForAdmin LFV = new LogFileViewerForAdmin();
                LFV.setVisible(true);
                LFV.setLocationRelativeTo( null );

                openFile(AbministratorLogListViewer.index);
            }
        });
    }
    ...
    public static void openFile(int index)
    {
        ...
        try
        {
            ...
            File file = new File("MARS-Administrator-LogFile-"+ indexHe +".log");
